...
2. Run the SQL in the `supabase/migrations` folder in order, starting with `20260327_initial.sql` and including `20260405_profile_payment_methods.sql` and the direct-read policy in `20260405_response_tip_methods.sql`.
