...
- Name: visual.spec.ts >> shared-recording route at desktop
- Location: tests\playwright\visual.spec.ts:173:5

# Error details

```
Error: A snapshot doesn't exist at C:\Projects\Test4Test-Redesign\tests\playwright\visual.spec.ts-snapshots\shared-recording-desktop-visual-win32.png.
```
...
- generic [ref=e4]:
  ...
  - main [ref=e18]:
    - generic [ref=e21]:
      - generic [ref=e22]:
        - paragraph [ref=e23]: Shared recording
        - heading "Palette Pilot" [level=1] [ref=e24]
      - generic "Palette Pilot recording" [ref=e26]: Your browser does not support embedded video playback.
```
