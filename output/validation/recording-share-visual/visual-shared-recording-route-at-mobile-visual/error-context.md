...
- Name: visual.spec.ts >> shared-recording route at mobile
- Location: tests\playwright\visual.spec.ts:173:5

# Error details

```
Error: A snapshot doesn't exist at C:\Projects\Test4Test-Redesign\tests\playwright\visual.spec.ts-snapshots\shared-recording-mobile-visual-win32.png.
```
